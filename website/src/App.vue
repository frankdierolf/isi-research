        ...
        <div class="section__inner">
          ...
          <div class="download__content animate-on-scroll">
            ...
            <div class="download__card">
              ...
              <a href="https://github.com/isi-research/isi-desktop/releases" class="btn btn--download" target="_blank" rel="noopener">
                Download for macOS
                <svg class="btn__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      ...
      <section id="about" class="about">
        <div class="section__inner">
          ...
          <div class="about__content animate-on-scroll">
            <h2 class="about__title">About the Institute</h2>
            <div class="about__text">
              <p>
                The Ulm Institute of Spoken Intelligence (ISI) is dedicated to advancing
                research in multimodal artificial intelligence, with a particular focus
                on voice-based interaction paradigms for creative and productive workflows.
              </p>
              <p>
                Founded with the mission to reduce friction between human intent and
                computational output, we develop novel interfaces that leverage natural
                language understanding and generative models to create more intuitive
            ...
            <div class="about__contact">
              ...
              <p class="about__contact-text">
                For research inquiries or collaboration opportunities:<br>
                <a href="mailto:research@isi-research.org" class="about__email">research@isi-research.org</a>
              </p>
              <a href="https://github.com/isi-research" class="about__github" target="_blank" rel="noopener">
